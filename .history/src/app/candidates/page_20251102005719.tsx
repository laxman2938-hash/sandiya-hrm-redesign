                ...
                <div className="relative border-2 border-dashed border-slate-300 rounded-lg p-6 hover:border-blue-500 transition cursor-pointer group">
                  ...
                  <div className="text-center">
                    <div className="text-3xl mb-2">
                      {files.passport ? 
                        (files.passport.type === 'application/pdf' ? '📄' : '🖼️') 
                        : '📄'
                      }
                    </div>
                      ...
                      {files.passport ? (
                        <span className="flex items-center justify-center gap-2">
                          <span className={`px-2 py-1 rounded text-xs font-bold ${
                            files.passport.type === 'application/pdf' 
                              ? 'bg-red-100 text-red-700' 
                              : 'bg-blue-100 text-blue-700'
                          }`}>
                            {files.passport.type === 'application/pdf' ? 'PDF' : 'IMAGE'}
                          </span>
                          <span className="truncate max-w-40">{files.passport.name}</span>
                        </span>
