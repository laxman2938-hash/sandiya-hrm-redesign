                ...
                >
                  <div className="aspect-square bg-linear-to-br from-blue-200 to-blue-300 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition flex items-center justify-center">
                      <div className="opacity-0 group-hover:opacity-100 transition bg-white/90 rounded-full p-3 backdrop-blur-sm">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/80 to-transparent p-4 translate-y-2 group-hover:translate-y-0 transition-transform">
                    <p className="text-white font-semibold text-sm md:text-base line-clamp-2">{achievement.title}</p>
                    <p className="text-white/80 text-xs mt-1">Click to view full image</p>
                  </div>
                </div>
              ))}
            </div>
